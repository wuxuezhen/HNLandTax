...
@protocol JMLabelDelegate <NSObject>

-(void)jm_label:(JMLabel *)label didSelectedString:(NSString *)selectedStr forStyle:(HandleStyle)style inRange:(NSRange)range;
...
/** 代理 */
@property(nonatomic, weak) id<JMLabelDelegate>  delegate;
