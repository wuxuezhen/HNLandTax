...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    ...
    // 4 代理
    if ([self.delegate respondsToSelector:@selector(jm_label:didSelectedString:forStyle:inRange:)]) {
        [self.delegate jm_label:self didSelectedString:selectedString forStyle:self.tapStyle inRange:self.selectedRange];
    }
