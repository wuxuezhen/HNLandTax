...
- (void)resetSubviews{
    ...
    self.startImageView.image = [UIImage imageNamed:@"videoClipArrow"];
    ...
    self.endImageView.image =  [UIImage imageNamed:@"videoClipArrow"];
...
- (void)updateBorderFrames{
    ...
    [self drawDashLine:self.topBorder lineLength:5 lineSpacing:5 lineColor:self.themeColor];
    [self drawDashLine:self.bottomBorder lineLength:5 lineSpacing:5 lineColor:self.themeColor];
}
